...
{
	//double GaussianSigmaX = parameters->get_
	...
	while (true)
	{
		...
		*/
		...
		cout << "这个程序运行时间为：" << 1000.0 / (end_time - star_time) << "frame/s." << endl;
	...
	std::vector<std::string> files)
{
	...
	while (true)
	{
		...
		*/
		...
		//Test_EdgeDetection_v1(MyVision); //TODO::Copy your opencv and visp tests into these functions.
		//Test_EdgeDetection_v2(MyVision);
